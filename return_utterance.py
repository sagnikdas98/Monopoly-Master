...
set_board=["Your virtual board has been set for {} players. ","I created a board for {} players.", "A game for {} players is ready."]
...
want_to_buy_house=["Do you want to build a house here for ${}?"]
...
want_to_buy_prop=["Do you wish to buy this property for ${}?"]

player_in_jail=["Oops. Looks like you are in jail right now."]

jail_card_or_money=["Do you wish to use jail card or pay $50 to get out of jail or pass to the next player."]

jail_card=["Do you wish to use you jail card to get out of jail?"]

jail_money=["Do you wish to pay $50 to get out of jail?" ]

want_to_buy_railroad = ["Do you want to buy this rail road for ${} ?"]

want_to_buy_utility = ["Do you want to buy this utility for ${}?"]
...
tax_pass = ["${} has been deducted from your account."]
...
you_have_paid_rent_to = ["You have paid rent of ${} to player {}."]

insufficient_balance_rent = ["Due to insufficient balance for rent you lose."]

current_balance = ["You currently have ${} in your account."]
